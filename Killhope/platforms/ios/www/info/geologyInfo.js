var info = [
	{
		...
		"title":"Early Earth",
		"text":[
			"About 450 million years ago, during the Ordovician period of Earth history, the area we know as northern England was located 15°S of the equator (Matte, 2001). Here it lay beneath a deep ocean, in which mud and silt were deposited.",
	...
	{
		"id":"granite",
		"title":"The Weardale Granite",
		"text":[
			"Movement of the Earths plates caused compression in the North East of England, beginning at around 490 million years ago.",
	...
	{
		"id":"sediments",
		"title":"Carboniferous Sediments",
		"text":[
			"In the Early Carboniferous movement of the Earths tectonic plates  opened up sedimentary basins in Northumberland and Yorkshire. This allowed the deposition of the Carboniferous sedimentary rocks we observe today during the period from 354-300 million years ago.",
	...
	{
		"id":"ore_field",
		"title":"Formation of the North Pennine Ore Field",
		"text":[
			"At great depths in the Earth, rocks can be saturated with saline water, very much like sea water, this often dissolves chemical elements from the surrounding rocks which contain traces or iron, lead, zinc and the various elements found in Northern Pennines mineral deposits.",
